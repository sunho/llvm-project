; ModuleID = 'incr_module_20.submodule.0x36e474c0b40fcd64.ll'
...
define dso_local void @_Z12randomVectorv(ptr noalias sret(%struct.Vec3) align 8 %agg.result) #0 {
entry:
  %x = getelementptr inbounds %struct.Vec3, ptr %agg.result, i32 0, i32 0
  %call = call noundef double @_ZNSt19normal_distributionIdEclISt23mersenne_twister_engineImLm32ELm624ELm397ELm31ELm2567483615ELm11ELm4294967295ELm7ELm2636928640ELm15ELm4022730752ELm18ELm1812433253EEEEdRT_(ptr noundef nonnull align 8 dereferenceable(25) @nDist, ptr noundef nonnull align 8 dereferenceable(5000) @gen)
  store double %call, ptr %x, align 8
  %y = getelementptr inbounds %struct.Vec3, ptr %agg.result, i32 0, i32 1
  %call1 = call noundef double @_ZNSt19normal_distributionIdEclISt23mersenne_twister_engineImLm32ELm624ELm397ELm31ELm2567483615ELm11ELm4294967295ELm7ELm2636928640ELm15ELm4022730752ELm18ELm1812433253EEEEdRT_(ptr noundef nonnull align 8 dereferenceable(25) @nDist, ptr noundef nonnull align 8 dereferenceable(5000) @gen)
  store double %call1, ptr %y, align 8
  %z = getelementptr inbounds %struct.Vec3, ptr %agg.result, i32 0, i32 2
  %call2 = call noundef double @_ZNSt19normal_distributionIdEclISt23mersenne_twister_engineImLm32ELm624ELm397ELm31ELm2567483615ELm11ELm4294967295ELm7ELm2636928640ELm15ELm4022730752ELm18ELm1812433253EEEEdRT_(ptr noundef nonnull align 8 dereferenceable(25) @nDist, ptr noundef nonnull align 8 dereferenceable(5000) @gen)
  store double %call2, ptr %z, align 8
  ret void
}
