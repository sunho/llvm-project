; ModuleID = 'incr_module_13.submodule.0x920be57d07fd6ef1.ll'
...
; Function Attrs: noinline uwtable
define hidden void @__orc_lcl._GLOBAL__sub_I_incr_module_13.3() #0 section ".text.startup" {
entry:
  call void @__orc_lcl.__cxx_global_var_init.2()
  ret void
}
