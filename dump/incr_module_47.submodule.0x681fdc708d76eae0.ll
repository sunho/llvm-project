; ModuleID = 'incr_module_47.submodule.0x681fdc708d76eae0.ll'
source_filename = "incr_module_47"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.Color.21 = type { double, double, double }

; Function Attrs: mustprogress noinline optnone uwtable
define dso_local void @_ZmlRK5Colord(ptr noalias sret(%struct.Color.21) align 8 %agg.result, ptr noundef nonnull align 8 dereferenceable(24) %lhs, double noundef %rhs) #0 {
entry:
  ...
  %r = getelementptr inbounds %struct.Color.21, ptr %0, i32 0, i32 0
  %1 = load double, ptr %r, align 8
  %2 = load double, ptr %rhs.addr, align 8
  %mul = fmul double %1, %2
  %3 = load ptr, ptr %lhs.addr, align 8
  %g = getelementptr inbounds %struct.Color.21, ptr %3, i32 0, i32 1
  %4 = load double, ptr %g, align 8
  %5 = load double, ptr %rhs.addr, align 8
  %mul1 = fmul double %4, %5
  %6 = load ptr, ptr %lhs.addr, align 8
  %b = getelementptr inbounds %struct.Color.21, ptr %6, i32 0, i32 2
  %7 = load double, ptr %b, align 8
  %8 = load double, ptr %rhs.addr, align 8
  %mul2 = fmul double %7, %8
  call void @_ZN5ColorC2Eddd(ptr noundef nonnull align 8 dereferenceable(24) %agg.result, double noundef %mul, double noundef %mul1, double noundef %mul2)
  ret void
}
