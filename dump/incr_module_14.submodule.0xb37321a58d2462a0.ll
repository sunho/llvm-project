; ModuleID = 'incr_module_14.submodule.0xb37321a58d2462a0.ll'
...
define hidden void @__orc_lcl.__cxx_global_var_init.4() #0 section ".text.startup" {
entry:
  call void @_ZNSt25uniform_real_distributionIdEC2Edd(ptr noundef nonnull align 8 dereferenceable(16) @uDist, double noundef 0.000000e+00, double noundef 1.000000e+00)
  ret void
}
