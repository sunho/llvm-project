; ModuleID = 'incr_module_13.submodule.0xafaf9214f75f4cc0.ll'
...
define hidden void @__orc_lcl.__cxx_global_var_init.2() #0 section ".text.startup" {
entry:
  call void @_ZNSt19normal_distributionIdEC2Edd(ptr noundef nonnull align 8 dereferenceable(25) @nDist, double noundef 0.000000e+00, double noundef 1.000000e+00)
  ret void
}

; Function Attrs: noinline optnone uwtable
declare dso_local void @_ZNSt19normal_distributionIdEC2Edd(ptr noundef nonnull align 8 dereferenceable(25), double noundef, double noundef) #1 align 2
