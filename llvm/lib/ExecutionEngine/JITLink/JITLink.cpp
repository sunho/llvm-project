...
Expected<Symbol&> createAnonymousPointer(LinkGraph &G, Section &PointerSection,
  ...
  case Triple::aarch64:
    return aarch64::createAnonymousPointer_aarch64(G, PointerSection, InitialTarget, InitialAddend);
  case Triple::x86_64:
    return x86_64::createAnonymousPointer_x86_64(G, PointerSection, InitialTarget, InitialAddend);
  case Triple::x86:
    return i386::createAnonymousPointer_i386(G, PointerSection, InitialTarget, InitialAddend);
  case Triple::loongarch32:
  case Triple::loongarch64:
    return loongarch::createAnonymousPointer_loongarch(G, PointerSection, InitialTarget, InitialAddend);
    default:
...
Expected<Symbol&> createAnonymousPointerJumpStub(LinkGraph &G,
  ...
  switch (G.getTargetTriple().getArch()) {           
  case Triple::aarch64:
    return aarch64::createAnonymousPointerJumpStub_aarch64(G, StubSection, PointerSymbol);
  case Triple::x86_64:
    return x86_64::createAnonymousPointerJumpStub_x86_64(G, StubSection, PointerSymbol);
  case Triple::x86:
    return i386::createAnonymousPointerJumpStub_i386(G, StubSection, PointerSymbol);
  case Triple::loongarch32:
  case Triple::loongarch64:
    return loongarch::createAnonymousPointerJumpStub_loongarch(G, StubSection, PointerSymbol);
  default:
    return make_error<JITLinkError>("Unsupported architecture");
  }         
}
